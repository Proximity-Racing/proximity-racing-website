...
<body>
    ...
    <div class="container-fluid fixed4 fade">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 gap">
                ...
                <p class="lead pp fixedbackgroundtext">Proximity Racing is a sanctioned iRacing.com motorsport team.
                    Founded November 10th, 2016, our team started with five members. After our 24 Hours of Daytona run
                    coming short in 2017, we reformed our team, expanding our member base.</p>
                <br><br>
                <a href="./about.php"><button type="button" class="btn btn-primary btn-lg pp-btn">Learn
                        More</button></a>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid padding fade">
        <div class="row text-center padding">
            <div class="col-xs-12 col-md-12">
                ...
                <h1 class="mobile-header ps-sm"><a class="nolink" href="./blog4.php">Daytona High Banks Claim Proximity
                        Racing in iSCAR Competition</a></h1>
                <p class="mt-5 lead ps-3">While the harshness of a cold winter looms, putting an end to real-life
                    motorsport across America for the year, virtual action ramped up...</p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid fade fixed3">
        <div class="row">
            <div class="col-sm-12 col-md-6">
                ...
                <p class="lead pp mt-5" style="color:white;  text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;font-size: 22px !important;">
                    We are extremely fortunate to have our partners on board our vehicles for the 2020 season. Not only
                    do they help us by providing opportunities to develop our talented drivers, but we help them get
                    the best exposure on and off the track by frequently promoting their business on social media and
                    using industry leading marketing strategies.</p>
                <a href="./about.php"><button type="button" class="btn btn-primary btn-lg pp mt-5">Learn
                        More</button></a>
            </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text">Chris is the Founder of Proximity Racing and currently serves as the
                            website designer and vice president.</p>
                        <div class="mt-auto">
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text">Cory is the current President of Proximity Racing and currently serves as
                            an active driver.</p>
                        <div class="mt-auto">
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text">Michael DiMaggio is the Co-Founder and currently serves on the
                            administration team at Proximity Racing.</p>
                        <div class="mt-auto">
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text">Tre Shuttlesworth is an active board member and serves as the teams
                            secretary and blogger.</p>
                        <div class="mt-auto">
    ...
    <div class="container-fluid padding fade gap gap-bot">
        <div class="row text-center padding">
            <div class="col-12">
                <h1>Connect</h1>
                <p class="lead mt-4">Keep up with the action on our social media! We post actively and give live feed
                    updates on major races we run.</p>
            </div>
